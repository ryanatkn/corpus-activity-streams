import {VocabularyTerm} from './activity_streams.js';

export const examples: {[key: string]: VocabularyTerm[]} = {
	Object: [
		{
	...
	Add: [
		...
		},
		{
			...
			type: 'Add',
			actor: {type: 'Person', name: 'Sally'},
			object: {type: 'Image', name: 'A picture of my cat', url: 'http://example.org/img/cat.png'},
	...
	attachment: [
		{
			...
			attachment: [
				{type: 'Image', content: 'This is what he looks like.', url: 'http://example.org/cat.jpeg'},
			],
		},
	],
	attributedTo: [
	...
	current: [
		...
		},
		{
			...
			type: 'Collection',
			totalItems: 3,
			current: {type: 'Link', summary: 'Most Recent Items', href: 'http://example.org/collection'},
			items: [
				'http://example.org/posts/1',
				'http://example.org/posts/2',
				'http://example.org/posts/3',
	...
	first: [
		...
		},
		{
			...
			type: 'Collection',
			totalItems: 3,
			first: {type: 'Link', summary: 'First Page', href: 'http://example.org/collection?page=0'},
		},
	],
	generator: [
		{
	...
	last: [
		...
		},
		{
			...
			type: 'Collection',
			totalItems: 5,
			last: {type: 'Link', summary: 'Last Page', href: 'http://example.org/collection?page=1'},
		},
	],
	location: [
		{
	...
	next: [
		...
		},
		{
			...
			summary: "Page 2 of Sally's blog posts",
			type: 'CollectionPage',
			next: {type: 'Link', name: 'Next Page', href: 'http://example.org/collection?page=2'},
			items: [
				'http://example.org/posts/1',
				'http://example.org/posts/2',
				'http://example.org/posts/3',
	...
	prev: [
		...
		},
		{
			...
			summary: "Page 1 of Sally's blog posts",
			type: 'CollectionPage',
			prev: {type: 'Link', name: 'Previous Page', href: 'http://example.org/collection?page=1'},
			items: [
				'http://example.org/posts/1',
				'http://example.org/posts/2',
				'http://example.org/posts/3',
	...
	url: [
		...
		},
		{
			...
			url: [
				...
				{type: 'Link', href: 'http://example.org/4q-sales-forecast.html', mediaType: 'text/html'},
			],
		},
	],
	accuracy: [
	...
	content: [
		...
		},
		{
			...
			summary: 'A simple note',
			type: 'Note',
			contentMap: {en: 'A simple note', es: 'Una nota sencilla', 'zh-Hans': '一段简单的笔记'},
		},
		{
			'@context': 'https://www.w3.org/ns/activitystreams',
			summary: 'A simple note',
	...
	summary: [
		...
		},
		{
			...
			name: 'Cane Sugar Processing',
			type: 'Note',
			summaryMap: {en: 'A simple note', es: 'Una nota sencilla', 'zh-Hans': '一段简单的笔记'},
		},
	],
	totalItems: [
		{
...
Other examples not specific to one vocabulary term:]
			...
			items: [
				{
					...
					context: {type: 'http://example.org/Project', name: 'Project XYZ'},
					audience: {type: 'Group', name: 'Project XYZ Working Group'},
 ...
 [{
			...
			items: [
				...
				},
				{
					...
					target: {type: 'Collection', summary: "John's Connections"},
					context: 'http://example.org/connections/123',
				},
				{
					...
					actor: 'acct:sally@example.org',
					object: 'http://example.org/connections/123',
					target: {type: 'Collection', summary: "Sally's Connections"},
					context: 'http://example.org/connections/123',
				},
			],
		}],
 ...
 [{
			...
			oneOf: [{name: 'arduino'}, {name: 'raspberry pi'}],
		}],
 [{
			'@context': 'https://www.w3.org/ns/activitystreams',
			attributedTo: 'http://sally.example.org',
 ...
 [{
			...
			result: {type: 'Note', content: 'Users are favoriting "arduino" by a 33% margin.'},
		}],
 [{
			'@context': 'https://www.w3.org/ns/activitystreams',
 ...
 [{
			...
			to: {name: 'Sally', type: 'Person', id: 'http://sally.example.org'},
			tag: {id: 'http://example.org/tags/givingthanks', name: '#givingthanks'},
		}],
 [{
			'@context': 'https://www.w3.org/ns/activitystreams',
			name: 'A thank-you note',
			...
			content: 'Thank you @sally for all your hard work! #givingthanks',
			tag: [
				{type: 'Mention', href: 'http://example.org/people/sally', name: '@sally'},
				{id: 'http://example.org/tags/givingthanks', name: '#givingthanks'},
			],
		}],
 [{
			'@context': 'https://www.w3.org/ns/activitystreams',
			...
			type: 'Move',
			actor: 'http://sally.example.org',
			object: {type: 'Document', name: 'sales figures'},
			origin: {type: 'Collection', name: 'Folder A'},
			target: {type: 'Collection', name: 'Folder B'},
		},
