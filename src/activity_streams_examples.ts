// generated by src/activity_streams_examples.gen.ts
import type {Vocabulary_Term} from 'src/activity_streams.js';
export const examples: {[key: string]: Vocabulary_Term[]} = {
	Object: [
		{
	...
	name: [
		{'@context': 'https://www.w3.org/ns/activitystreams', type: 'Note', name: 'A simple note'},
		{
			'@context': 'https://www.w3.org/ns/activitystreams',
			type: 'Note',
